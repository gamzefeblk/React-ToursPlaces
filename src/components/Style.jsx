...
import image from "./bluesky.jpg"


export const HeaderContent = style.div`
...
padding: ${props => props.header ? "1vh" : "4vh"};
color: ${props => props.header ? "white" : "black"};
font-size: ${props => props.header ? "1.5rem" : ""};
text-align: center;
margin: ${props => props.header ? "2vh" : ""};
`
